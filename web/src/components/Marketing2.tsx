...
/* ───────── SLA / TURNAROUND ───────── */
export function SLA({ onOrder }: { onOrder: () => void }) {
  const tiers = [
    {
      name: "Standard",
      time: "6–10 hr",
      ...
      <div style={{ maxWidth: "var(--tp-maxw)", margin: "0 auto" }}>
        ...
        >
          <div>
            ...
            <button className="nj2-btn tp-btn-accent" style={{ marginTop: 28 }} onClick={onOrder}>
...
/* ───────── CTA + FOOTER ───────── */
export function CTAFooter({ onOrder }: { onOrder: () => void }) {
      ...
      <div style={{ maxWidth: "var(--tp-maxw)", margin: "0 auto", position: "relative" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <button className="nj2-btn nj2-btn-lg tp-btn-accent" style={{ justifyContent: "center" }} onClick={onOrder}>
